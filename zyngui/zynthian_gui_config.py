...
# counter, pattern editor playhead, MIDI activity. Higher rates cost CPU that
# sound generation may need, so the defaults are as low as still reads well.
ui_fps = max(1, min(60, get_env_int('ZYNTHIAN_UI_FPS', 20)))
