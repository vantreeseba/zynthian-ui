...
class zynthian_state_manager:
    ...
    def set_record_count_in(self, bars):
        """Set the metronome count-in for clip recording armed from stopped transport

        bars: Count-in duration in bars before punch in (0 to disable)
        """
